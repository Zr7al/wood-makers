/* ============================================================
   WOOD MAKER EST. — Website JS
   Custom cursor · Navigation · Scroll animations · Filter · Modal
   ============================================================ */
...
if (dot && ring && window.innerWidth > 768) {
  ...
  const hoverEls = 'a,button,.filter-btn,.proj-item,.proj-preview-card,.service-card,.ps-step,.modal-thumb,.modal-nav-btn,.modal-close';
